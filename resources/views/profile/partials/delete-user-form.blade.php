<section>
    <header class="mb-3">
        <h2 class="h6 fw-bold mb-1">{{ __('Delete Account') }}</h2>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()">
        <form method="post" action="{{ route('profile.destroy') }}">
            ...
            <div class="mb-3">
                ...
                <x-text-input id="password" name="password" type="password" placeholder="{{ __('Password') }}" autocomplete="current-password" enterkeyhint="done" />
